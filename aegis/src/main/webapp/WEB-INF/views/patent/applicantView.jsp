...
(function($){
	...
	$(document).ready(function(){
		$('#btnSetApplicant').bind('click', setApplicant);
			...
			<div class="contsMiddle">
				...
				<div class="contBody">
					...
					<div class="searchResults">
						<h4>대표명화 (완료)<span class="flR"><button type="button" id="btnSave1" class="btnSmall green">저장</button></span></h4>
						<div id="gridList1" class="mt10 mb20" style="background-color:white; width:100%; height:200px;"></div>
						<h4>대표명화 대상<span class="flR"><button type="button" id="btnSave2" class="btnSmall green">저장</button></span></h4>
						<div class="expression">
							<p class="right">
								<span class="green">선택 출원인 대표명 일괄입력</span>&nbsp;
								<input type="text" id="txtReName" placeholder="대표명 입력 칸" title="대표명 입력 칸" class="w40" />
								<button id="btnSetApplicant" type="button" class="btnSmall gray">입력</button>
							</p>
						</div>
