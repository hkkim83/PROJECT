	...
	jQuery("#ToggleSmartFinder, #DummySmartFinder, #ToggleSmartFinder2").click(function(){
		...
		if(sf_stat == "close")
		{
			...
			jQuery("#ToggleSmartFinder")
				.prop("alt", "스마트검색 닫기")
				.prop("src", "/resources/images/common/btn_smartfinder_close.gif");
...
function BindOnoffAutoScroll() {
	...
	else // 자동스크롤 켜기
	{
		jQuery("#btnDummyOnoffAutoScroll")
			.prop("alt", "자동스크롤 끄기")
			.prop("src", "/resources/images/common/txt_Cscroll_stop.gif");
		jQuery("#btnOnoffAutoScroll")
			.prop("alt", "자동스크롤 끄기")
			.prop("src", "/resources/images/common/txt_Cscroll_stop.gif");
	}
...
function BindClearSmartFinder()
{
	...
	jQuery("select[id^='KEYWORD']", jQuery("#divSmartFinder")).val("");
