...
public class PriorityInfo  implements java.io.Serializable {
    ...
    /**
     * Gets the literatureNumber value for this PriorityInfo.
     * 
    ...
    /**
     * Sets the literatureNumber value for this PriorityInfo.
     * 
    ...
    /**
     * Gets the countryCode value for this PriorityInfo.
     * 
     * @return countryCode
     */
    ...
    /**
     * Sets the countryCode value for this PriorityInfo.
     * 
     * @param countryCode
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://plus.kipris.or.kr/xsd", ">priorityInfo"));
